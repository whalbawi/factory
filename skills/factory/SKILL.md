...
After presenting findings, propose a `CLAUDE.md`.

**If no CLAUDE.md exists**: Present the full proposed content and ask
the user to confirm or provide feedback.
...
## Project Summary
[1-3 sentences: what this is, who it's for, what it does]
